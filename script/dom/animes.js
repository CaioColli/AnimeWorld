...
export function animesDOM() {
    ...
    const prevButton = document.querySelector('#editor-picks-animes-prev-button')
    const nextButton = document.querySelector('#editor-picks-animes-next-button')

    let currentIndex = 0 

    if (list && prevButton && nextButton) {
        const items = document.querySelectorAll('#list-editor-picks-animes')
